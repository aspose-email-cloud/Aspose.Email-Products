---
title: Send Messages with attachment using Python REST API 
description: REST API for building cloud email solutions in Python to send, store and manage emails in the cloud 
weight: 80
url: /python
---

{{< blocks/products/pf/main-wrap-class >}}
{{< blocks/products/pf/upper-banner h1="Send Cloud Emails via Python REST API" h2="REST API for building cloud email solutions in Python to send, store and manage emails in the cloud." logoImageSrc="/headers/aspose_email-for-python.png" pfName="Aspose.Email" subTitlepfName="Cloud SDK for Python" downloadUrl="" >}}

{{< blocks/products/pf/main-container pfName="Aspose.Email" subTitlepfName="Cloud SDK for Python" >}}

{{< blocks/products/pf/sub-menu logoImageSrc="/sdk/aspose_email-for-python.png" PricingLink="https://purchase.aspose.cloud/pricing" buyLink="https://dashboard.aspose.cloud" docsLink="https://docs.aspose.cloud/email" directDownloadLink="https://github.com/aspose-email-cloud/aspose-email-cloud-python" liveDemosLink="https://products.aspose.app/email/family"  >}}

{{< blocks/products/pf/tab-content >}}
<p>Through Aspose.Email Cloud SDK for Python, you can send simple as well as MIME email messages, work with email attachments, specify red flag settings, download attachments and manage email folders.</p>
{{< /blocks/products/pf/tab-content >}}
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_email-for-python.png" alt="Python Email Cloud"><header>Aspose.Email</header><footer>Cloud <small> <em>for </em> </small>Python</footer></div>
<!--/logo--></div>
<!--/diagram1-->
...
<!--/right--></div>
<!--/row-->
<div class="d1-logo"><img src="/sdk/aspose_email-for-python.png" alt="Python Cloud for EML & MSG"><header>Aspose.Email</header><footer>Cloud <small> <em>for </em> </small>Python</footer></div>
<!--/logo--></div>
<!--/diagram2-->
{{< /blocks/products/pf/carousel-item >}}
 ...
 <div class="row">
  <div class="container">
   ...
   <div class="col-lg-12">
    ...
    <p>
     It is easy to get started with Aspose.Email Cloud SDK for Python and there is nothing to install. Simply create an account at
     <a href="https://dashboard.aspose.cloud/#/apps">
      Aspose for Cloud
     </a>
     and get your application information. Once you have the App SID &amp; key, you are ready to give the Aspose.Email Cloud SDK for Python a try with any language - on any platform that supports HTTP requests and responses. It is a REST API that can be used to create email archiving applications capable of managing and manipulating email messages.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Being a well structured API, Aspose.Email Cloud SDK for Python allows developers to convert hosted email messages on the fly as well as retrieve them from a mailbox. It can be used to convert between EML and MSG email formats.
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-element name="Source Code" href="https://github.com/aspose-email-cloud/aspose-email-cloud-python" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Why Aspose.Email Cloud SDK for Python?" tabId="success-stories" >}}
