---
title: Ruby REST API to Send Emails via Cloud | Build Email Solutions 
description: Create a simple cloud email management application in Ruby for sending, appending, converting and managing emails (MSG & EML)
weight: 90
url: /ruby
---
...
<div class="container-fluid features-section bg-gray singleproduct">
 ...
 <div class="row">
  <div class="container">
   <h2 class="pr-ft">
    Advanced Features of Aspose.Email Cloud SDK for Ruby
   </h2>
   <p>
   </p>
   <div class="col-lg-4">
   ...
   <div class="col-lg-12">
    ...
    <p>
     It is easy to get started with Aspose.Email Cloud SDK for Ruby and there is nothing to install. Simply create an account at
     <a href="https://dashboard.aspose.cloud/#/apps">
      Aspose for Cloud
     </a>
     and get your application information. Once you have the App SID &amp; key, you are ready to give the Aspose.Email Cloud SDK for Ruby a try with any language - on any platform that supports HTTP requests and responses. It is a REST API that can be used to create email archiving applications capable of managing and manipulating email messages.
    </p>
   </div>
   <div class="col-lg-12">
    <h2 class="h2title">
    ...
    <p>
     Being a well structured API, Aspose.Email Cloud SDK for Ruby allows developers to convert hosted email messages on the fly as well as retrieve them from a mailbox. It can be used to convert between EML and MSG email formats.
    </p>
   </div>
  </div>
 </div>
...
{{< blocks/products/pf/slr-element name="Source Code" href="https://github.com/aspose-email-cloud/aspose-email-cloud-ruby" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Why Aspose.Email Cloud SDK for Ruby?" tabId="success-stories" >}}
...
{{< blocks/products/pf/offers-section pfName="Aspose.Email" >}}
    ...
    {{< blocks/products/pf/offers-section-item link="/email/swift" imgSrc="/sdk/aspose_email-for-swift.png" platform="Swift" >}}
